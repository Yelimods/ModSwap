...
Testing ModSwap
---------------
Thank you very much for agreeing to test ModSwap.  Your help and input is greatly appreciated.  In case you noticed, I used to be Yeliab on FS-UK, and now I am Yelibam!
I don't want you to risk affecting your game folders, so I have provided a testing environment, which you could unzip somewhere on your computer.  This is a mock-up of the FS/LS game folder, but it contains no real game files.  To begin testing I suggest that you install ModSwap into this.
